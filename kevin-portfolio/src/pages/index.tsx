        ...
        <div className="container flex flex-col items-center justify-center px-4 py-16 ">
          ...
          <div className="hero bg-base">
            <div className="hero-content flex-col lg:flex-row">
              ...
              className="max-w-40 max-h-72"/>            
              <div>
                <h1 className="text-5xl font-bold text-white">About Me</h1>
                <p className="py-6 text-white">{"I'm a current Johns Hopkins Undergraduate studying a B.S. in Computer Science and a minor in Applied Mathematics & Statistics. I hope to continue my education by pursuing Hopkin's combined BS/MSE 4 year program."}</p>
          ...
          <span className="footer-title text-2xl translate-y-20">Contact and Links</span>
      </div>
      <footer className="footer p-12 bg-neutral text-neutral-content gap-12 justify-center text-center bg-gradient-to-b from-[#020d4b] to-[#02054b] h-28 py-10 translate-y-5">
        <div className = "-translate-y-6 -translate-x-8 flex flex-col items-center">
